...
def main():
    ...
    parser.add_argument(
        '--translation-filename', help='the filename of a file of target-base translations')
    parser.add_argument(
        '--frequency-list-filename', help='the filename of a file of words, ranked by frequency, one per line')
